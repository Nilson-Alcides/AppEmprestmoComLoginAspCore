...
namespace AppLayoutAspCore.Repository
{
    public class LivroRepository : ILivroRepository
    {
        ...
        public void Cadastrar(Livro livro)
        {
            ...
            {
                conexao.Open();
                MySqlCommand cmd = new MySqlCommand("insert into Livro values(default, @NomeLivro, @ImagemLivro)", conexao);
        ...
        public Livro ObterLivros(int Id)
        {
            ...
            {
                conexao.Open();
                MySqlCommand cmd = new MySqlCommand("select * from Livro where codLivro=@cod", conexao);
        ...
        public IEnumerable<Livro> ObterTodosLivros()
        {
            ...
            {
                conexao.Open();
                MySqlCommand cmd = new MySqlCommand("select * from Livro", conexao);
